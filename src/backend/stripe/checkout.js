...
exports.checkoutSessionDetails = exports.createPortalSession = exports.createCheckoutSession = void 0;
 ...
 */
exports.createCheckoutSession = v2_1.https.onRequest({ secrets: [stripeSecretKey] }, async (req, res) => {
    // Set CORS headers
 ...
 */
exports.createPortalSession = v2_1.https.onRequest({ secrets: [stripeSecretKey] }, async (req, res) => {
    res.set("Access-Control-Allow-Origin", "*");
    res.set("Access-Control-Allow-Methods", "POST, OPTIONS");
    res.set("Access-Control-Allow-Headers", "Content-Type");
    if (req.method === "OPTIONS") {
 ...
 */
exports.checkoutSessionDetails = v2_1.https.onRequest({ secrets: [stripeSecretKey] }, async (req, res) => {
    res.set("Access-Control-Allow-Origin", "*");
    ...
    try {
        ...
        res.status(200).json({
            ...
            customer_email: typeof session.customer === "object" && session.customer && !session.customer.deleted ?
