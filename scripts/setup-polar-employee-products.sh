...
EMPLOYEES=(
    ...
    "POLAR_EMPLOYEE_CONTENT_CREATOR_PRODUCT_ID|Content Creator|109"
    "POLAR_EMPLOYEE_DATA_ENGINEER_PRODUCT_ID|Data Engineer|139"
    "POLAR_EMPLOYEE_LEGAL_ADVISOR_PRODUCT_ID|Legal Advisor|169"
    "POLAR_EMPLOYEE_HR_SPECIALIST_PRODUCT_ID|HR Specialist|119"
    "POLAR_EMPLOYEE_ECOMMERCE_SPECIALIST_PRODUCT_ID|E-commerce Specialist|119"
    "POLAR_EMPLOYEE_SOCIAL_MEDIA_MANAGER_PRODUCT_ID|Social Media Manager|99"
    "POLAR_EMPLOYEE_CUSTOMER_SUCCESS_MANAGER_PRODUCT_ID|Customer Success Manager|129"
)
